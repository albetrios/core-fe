...
export const DASHBOARD_KEYS = {
  ...
  stats: {
    ...
    billingNoPlan: 'stats.billingNoPlan',
    billingHintPlan: 'stats.billingHintPlan',
    billingCycleMonthly: 'stats.billingCycleMonthly',
    billingCycleYearly: 'stats.billingCycleYearly',
  },
  nextSteps: {
  ...
  billingCard: {
    ...
    noPlan: 'billingCard.noPlan',
    choosePlan: 'billingCard.choosePlan',
    manage: 'billingCard.manage',
  },
  ai: {
    heading: 'ai.heading',
