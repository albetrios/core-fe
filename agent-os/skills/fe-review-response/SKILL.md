...
Related: `fe-pre-pr-sweep` (the sweep before opening) · `fe-guard-authoring` (why "gate
added" is not evidence) · `fe-full-code-review` (producing a review).
